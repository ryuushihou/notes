export async function getAllNotes() {
    const response = await fetch(`http://localhost:1337/api/notes4s`)
...
export async function updateNote(uuid, data) {
    ...
    const response = await fetch(`http://localhost:1337/api/notes4s/${id}`, {
        method: 'PUT',
        headers: {
            Authorization: 'bearer ',
            "Content-Type": "application/json"
...
export async function getNote(uuid) {
    const response = await fetch(`http://localhost:1337/api/notes4s?filters[slug][$eq]=${uuid}`)
    const data = await response.json();
    return {
